...
- Create Angular project with ng: `ng new employeeregistration.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`employeeregistration.client.esproj`).
